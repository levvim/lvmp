...
my ($input, $somatic, $species, $output, $data, $help);
...
#/data/wolchok/PROJECT/refs/GRCh37hg19/ExAC.r0.3.sites.vep.vcf.gz
...
`$BCFTOOLS/bcftools annotate --annotations /data/wolchok/PROJECT/refs/GRCh37hg19/ExAC.r0.3.sites.vep.vcf.gz --columns AC,AN,AF --output-type v --output $output/xtra$somatic/exac.vcf $output/xtra$somatic/sortedSimpleVCF.vcf.gz`;
