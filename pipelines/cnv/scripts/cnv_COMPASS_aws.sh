...
aws s3 cp s3://immunoseqvault/COMPUTE/SRA/prj_16485.ngc /home/ec2-user/prj_16485.ngc
/home/ec2-user/sratoolkit.2.9.2-centos_linux64/bin/vdb-config --import /home/ec2-user/prj_16485.ngc $PROJECT/sam
#cp /home/ec2-user/prj_16485.ngc /home/ec2-user/ncbi/dbGaP-16485/
#cp /home/ec2-user/prj_16485.ngc /home/ec2-user/ncbi/
...
aws s3 cp s3://immunoseqvault/COMPUTE/Exomeseq/Images/facets_latest.simg "$CONTAINERS"/facets_latest.simg
...
## snp_pileup
singularity exec --bind $PROJECT:$PROJECT --bind $REFS:$REFS $CONTAINERS/facets_latest.simg \
snp-pileup                          \       
