...
cd $FILE/vcf/
for i in *.passed.somatic.snvs.vcf; do echo $i; ifix=${i%%.*}; ifix=${ifix##*/};
...
cd $FILE/vcf/
for i in *.mutect_regions.txt; do echo $i; ifix=${i%%.*}; ifix=${ifix##*/};
...
cd $FILE/
for i in vcf/*.merged_regions.txt; do echo $i; ifix=${i%%.*}; ifix=${ifix##*/};
...
cd $FILE/vcf
for i in *.merged_regions.txt; do echo $i; ifix=${i%%.*}; ifix=${ifix##*/};
